    ...
    Executor
{
     ...
     */
    function setProtocolFee(address recipient, uint16 rate)
        external
        onlyGovernor
    {
    ...
    function _takeAsk(
        ...
        console.log("exchangesLength");
        console.logUint(exchangesLength);
        ...
        for (uint256 i; i < exchangesLength; ) {
            ...
            console.logUint(exchange.index);

            console.log("exchange.listing.index");
            console.logUint(exchange.listing.index);

            console.log("exchange.listing.tokenId");
            console.logUint(exchange.listing.tokenId);

            console.log("exchange.listing.amount");
            console.logUint(exchange.listing.amount);

            console.log("exchange.listing.price");
            console.logUint(exchange.listing.price);

            console.log("exchange.taker.tokenId");
            console.logUint(exchange.taker.tokenId);

            console.log("exchange.taker.amount");
            console.logUint(exchange.taker.amount);
...

            {
                ...
                bool isValidOrder = _validateOrderAndListing(
                    order,
                    OrderType.ASK,
                    exchange,
                    _signatures,
