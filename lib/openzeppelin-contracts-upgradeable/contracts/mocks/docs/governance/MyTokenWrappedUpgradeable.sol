...
{
    function __MyTokenWrapped_init(IERC20Upgradeable wrappedToken) internal onlyInitializing {
    ...
    function __MyTokenWrapped_init_unchained(IERC20Upgradeable) internal onlyInitializing {}
